...
/** Attack Cooldown  */ u16 CHL_cd   (u8 character_code) { return cooldown[character_code];     }
/** Atk Duration     */ u16 CHL_atkD (u8 character_code) { return atk_duration[character_code]; }
